...
D_hopgcr = os.path.join(DIRECTORIO_BASE, DIRECTORIO_ANALIZADO[0])
D_hopgcv= os.path.join(DIRECTORIO_BASE, DIRECTORIO_ANALIZADO[1])
D_itocr= os.path.join(DIRECTORIO_BASE, DIRECTORIO_ANALIZADO[2])
D_itocv= os.path.join(DIRECTORIO_BASE, DIRECTORIO_ANALIZADO[3])
